package org.withmystar.shell.shared.activities;
 ...
 * {@code `<activity android:name="org.withmystar.shell.shared.activities.ReportActivity" android:theme="@style/Theme.AppCompat.TermuxReportActivity" android:documentLaunchMode="intoExisting" />` }
 * and
 * {@code `<receiver android:name="org.withmystar.shell.shared.activities.ReportActivity$ReportActivityBroadcastReceiver"  android:exported="false" />` }
