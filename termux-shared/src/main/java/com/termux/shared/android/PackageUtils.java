package org.withmystar.shell.shared.android;
...
public class PackageUtils {
    ...
    public static String getSigningCertificateSHA256DigestForPackage(@NonNull final Context context, @NonNull final String packageName) {
        try {
             ...
             * W/PackageManager: Failed to parse /path/to/org.withmystar.shell.tasker.apk: Signature mismatch for shared user: SharedUserSetting{xxxxxxx org.withmystar.shell/10xxx}
             */
