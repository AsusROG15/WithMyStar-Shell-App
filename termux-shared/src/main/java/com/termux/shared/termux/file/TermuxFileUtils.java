package org.withmystar.shell.shared.termux.file;

import static org.withmystar.shell.shared.termux.TermuxConstants.TERMUX_PREFIX_DIR_PATH;
...
import org.withmystar.shell.shared.file.FileUtilsErrno;
...
public class TermuxFileUtils {
     ...
     *
     *
     * Also note that running `/system/bin/ls -lhd /data/user/0/org.withmystar.shell` as secondary user will result
     * in `ls: /data/user/0/org.withmystar.shell: Permission denied` where `0` is primary user id but running
     * `/system/bin/ls -lhd /data/user/10/org.withmystar.shell` will result in
     * `drwx------ 6 u10_a149 u10_a149 4.0K 2021-xx-xx xx:xx /data/user/10/org.withmystar.shell` where `10` is
